			...
			<section>
				<v-layout row>
					...
					<v-hover>
						...
						>
							<v-layout fill-height column>
								<v-layout justify-center class="green pa-2">
					...
					<v-hover>
						...
						>
						<v-layout fill-height column>
							<v-layout justify-center class="yellow pa-2">
					...
					<v-hover>
						...
						>
						<v-layout fill-height column>
							<v-layout justify-center class="orange pa-2">
					...
					<v-hover>
						...
						>
						<v-layout fill-height column>
							<v-layout justify-center class="red pa-2">
