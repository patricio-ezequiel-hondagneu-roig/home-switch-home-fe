			...
			<v-container>
				<v-layout row>
					...
					<v-hover>
						...
						<v-layout fill-height column>
							<v-layout justify-center class="primary pa-2">
								<v-icon class="icono-grande">event</v-icon>
							</v-layout>
							<v-layout column class="verticalmente-desbordable">
								<v-card-title primary-title>
									<h1 class="headline mb-0">Publicaciones</h1>
								</v-card-title>
								<v-card-text>
									Ver, crear, modificar y eliminar publicaciones.
								</v-card-text>
							</v-layout>
						</v-layout>
						</v-card>
				...
				<v-layout row>
					<v-hover v-if="esSuperAdmin">
						...
						<v-layout fill-height column>
							<v-layout justify-center class="primary pa-2">
								<v-icon class="icono-grande">person</v-icon>
							</v-layout>
							<v-layout column class="verticalmente-desbordable">
								<v-card-title primary-title>
								...
								<v-card-text>
									Ver, crear, modificar y eliminar clientes.
								</v-card-text>
							</v-layout>
						</v-layout>
						</v-card>
					...
					<v-hover v-if="esSuperAdmin">
						<v-card
							...
							class="tarjeta-de-enlace"
							:class="`elevation-${ hover ? 12 : 2 }`"
							:to="{ name: 'administracion de admins' }"
						>
						<v-layout fill-height column>
							<v-layout justify-center class="primary pa-2">
								<v-icon class="icono-grande">person</v-icon>
							...
							<v-layout column class="verticalmente-desbordable">
								<v-card-title primary-title>
									<h1 class="headline mb-0">Admins</h1>
								</v-card-title>
								<v-card-text>
									Ver admins, darles o quitarles permisos de admin a clientes.
								</v-card-text>
							</v-layout>
						</v-layout>
						</v-card>
